...
config.transform.mpiifacegaze_eye_size = 224
...
config.gaze_estimator.normalized_camera_params_eye = 'data/calib/normalized_camera_params_eye.yaml'
...
config.demo.display_heatmap = False
